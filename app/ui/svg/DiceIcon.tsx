  ...
  return (
    ...
    >
      <path
        ...
        fill="url(#dice-gradient-icon-1-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-2-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-3-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-4-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-5-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-6-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-7-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-8-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-9-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-10-:rcf:)"
      ></path>
      <path
        ...
        fill="url(#dice-gradient-icon-11-:rcf:)"
      ></path>
      <defs>
        <linearGradient
          id="dice-gradient-icon-1-:rcf:"
          x1="-7.46504"
          y1="13.4219"
          x2="19.693"
          y2="9.24026"
