...
const DiceIcon:FC<{ id: string }> = ({ id }) => {
  return (
    <svg
      viewBox="0 0 38 32"
      focusable="false"
    ...
    >
      <path
        ...
        fill={`url(#dice-gradient-icon-1-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-2-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-3-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-4-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-5-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-6-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-7-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-8-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-9-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-10-${id}:rcf:)`}
      ></path>
      <path
        ...
        fill={`url(#dice-gradient-icon-11-${id}:rcf:)`}
      ></path>
      <defs>
        <linearGradient
